...
export default function GlobalClickHandler() {
  ...
  }, [view, layers, storedLayerViews, layerView]);
...
useEffect(() => {
  ...
  if(parcelFeature === null)  view.graphics.removeAll();
    ...
    const performHighlight = async () => {
      try {
        ...
        if (targetLayerView && !targetLayerView.destroyed) {
          ...
          // `${Realtime}/api/get-power?${powerParams}`
