...
export default function LonghaulDetails({ feature }) {
  ...
  const fields = useMemo(
    () => [
      ...
      { label: "LMP", value: attr.lmp },
      { label: "Fiber Loss", value: attr.fiber_loss },
      { label: "Length", value: attr.gis_length },
      { label: "Fiber Type", value: attr.fiber_type },
      { label: "From", value: attr.from_ },
      { label: "To", value: attr.to_ },
    ],
    [attr],
  );
