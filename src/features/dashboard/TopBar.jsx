...
import SearchWidget from "../map/widgets/SearchWidget";
import FeatureGuard from "../auth/FeatureGuard";
import { FAULT_CODES, DERIVED_FAULT_CODES, STALE_FAULT_WINDOW_DAYS, createEmptyRegionStats } from "../../shared/constants/faultCodes";

// Auto-discovered by src/permissions/featureRegistry.js.
...
// Rendered once, in the shell's header slot (features/dashboard/DashboardPage.jsx).
// Takes no props: the search widget, fault dropdown and profile menu each read
// what they need from context directly.
      ...
      <calcite-menu slot="content-end" className="flex items-center pr-6 gap-2">
        ...
        <div className="flex items-center gap-4 profile-notification">
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              {/* full_name is optional -- an invited user need never set one --
                  so fall back to the username rather than rendering a blank
                  avatar and an empty name. */}
              <calcite-avatar
