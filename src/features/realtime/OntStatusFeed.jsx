/**
 * Live ONT alarm feed. Rendered by MapCanvas.jsx once the view exists.
 *
 * Renders nothing. It subscribes to the socket in ./socket.js, applies each
 * alarm to the customer layer on the map, and publishes the per-region counts
 * into AlarmStatsContext -- which is what the left sidebar's Alarm State tab
 * reads. Until this has run once, those counts are null and LeftSidebar
...
import { createEmptyRegionStats } from "../../shared/constants/faultCodes";

export default function OntStatusFeed() {
