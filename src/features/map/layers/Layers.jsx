/**
 * Mounts every operational layer on the map. Rendered by MapCanvas.jsx once
 * the view exists.
 *
 * Each child under ./styles/ owns exactly one layer: it constructs it, applies
 * its renderer, and registers itself in LayersContext so filter widgets and
 * the layer list can find it by id. Adding a layer means adding a module there
 * and rendering it here -- nothing else in the app needs to know.
 */
...
import DC from "./styles/DC";
import Feeder from "./styles/Feeder";
import POPBoundary from "./styles/POPBoundary";
import Customer from "./styles/Customer";
import Zone from "./styles/Zone";
import POP from "./styles/POP";
import FAT from "./styles/FAT";
import JC from "./styles/JC";
